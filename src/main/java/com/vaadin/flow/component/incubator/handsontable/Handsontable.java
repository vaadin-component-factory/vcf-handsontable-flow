...
@JavaScript("frontend://handsontable/dist/numbro/numbro.js")
...
public class Handsontable extends Div {
  ...
  /**
   * retrieves data with the same structure that passed by <code>setData</code>.
   *
   * @param callback When the data is ready, <code>callback</code> is called and the received data
   *     is passed to it.
   */
  ...
  /**
   * @param callback When the settings is ready, <code>callback</code> is called and the received
   *     settings is passed to it.
   */
  ...
  private void receiveListOfStringArray(String uuidStr, String data) {
    ...
    Objects.requireNonNull(
        consumer, "listOfStringArrayConsumer with the given UUID was not found!");
  ...
  /**
   * sets headers of the table. It is used when the table has multiple header rows or merged cells
   * in the header.
   *
   * @param nestedHeaders
   * @see <a href="https://handsontable.com/docs/7.0.2/demo-nested-headers.html">Nested headers
   *     document on Handsontable website</a>
   */
